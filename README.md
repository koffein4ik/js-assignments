...
## Javascript Assignments  [![Build Status](https://travis-ci.org/AndreiBibikEpam/js-assignments.svg?branch=master)](https://travis-ci.org/AndreiBibikEpam/js-assignments)
...
```
* Open https://github.com/AndreiBibikEpam/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
